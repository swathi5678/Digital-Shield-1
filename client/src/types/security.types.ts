...
export type SoDViolationType = 'user_has_both_tcodes' | 'role_has_both_tcodes' | 'user_via_multiple_roles';
export type SoDViolationStatus = 'open' | 'in_review' | 'remediated' | 'accepted' | 'false_positive';
...
export interface SoDDetectionRun {
  id: string;
  project_id: string;
  run_name: string;
  uploaded_at: string;
