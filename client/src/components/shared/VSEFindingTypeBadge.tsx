import { VSEFindingType } from '../../types/security.types.js';

interface Props {
  type: VSEFindingType;
}

export default function VSEFindingTypeBadge({ type }: Props) {
  const map: Record<VSEFindingType, { bg: string; text: string; label: string }> = {
